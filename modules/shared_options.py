...
options_templates.update(
    options_section(
        ("ui", "User Interface", "ui"),
        {
            ...
            "gradio_theme": OptionInfo(shared_gradio_themes.ATLAS_THEME_NAME, "Theme", gr.Dropdown, lambda: {"choices": [shared_gradio_themes.ATLAS_THEME_NAME], "interactive": False}).needs_reload_ui(),
